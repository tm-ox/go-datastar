...
func main() {
	...
	entries := []struct {
		...
		{
			slug: "logos", title: "Logo Design", workType: "Logo Design", client: "Various", year: 2024,
		...
		{
			slug: "tg", title: "TripleGoal Platform UI", workType: "UI Design", client: "TripleGoal", year: 2023,
			tools:       "Figma",
		...
		{
			slug: "ntr", title: "Nags to Riches Catalogue", workType: "Print Design", client: "Nags to Riches", year: 2022,
			tools:       "InDesign",
		...
		{
			slug: "oxen-free", title: "Oxen Free", workType: "ID Design", client: "Oxen Free", year: 2021,
		...
		{
			slug: "redsky", title: "RedSky", workType: "Print Design", client: "RedSky", year: 2022,
			tools:       "InDesign",
		...
		{
			slug: "print", title: "Print Design", workType: "Print Design", client: "Various", year: 2023,
			tools:       "Adobe Illustrator,InDesign",
		...
		{
			slug: "saj", title: "Share A Jet", workType: "UI Design", client: "Share A Jet", year: 2023,
			tools:       "Penpot",
		...
		{
			slug: "fredst", title: "Fred St.", workType: "Web Design", client: "Fred St.", year: 2022,
		...
		{
			slug: "ynk", title: "Yes No Klub", workType: "Web Design", client: "Yes No Klub", year: 2021,
			tools:       "Alpine.js,Netlify CMS,Nuxt Content,Tailwind CSS,Vue/Nuxt3",
		...
		{
			slug: "mjo", title: "MJO Mortgage Solutions", workType: "Web Design", client: "MJO", year: 2022,
			tools:       "Alpine.js,Netlify CMS,Nuxt Content,Tailwind CSS,Vue/Nuxt3",
	...
	for _, w := range entries {
		_, err := database.Exec(
			`INSERT OR IGNORE INTO work (slug, title, type, client, year, tools, description, website, link, cover_url) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
