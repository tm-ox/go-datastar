...
func main() {
	...
	images := map[string][]img{
		...
		// desktop/mobile alternating pairs
		"tg": {
			{"https://tmox.net/_astro/tg-gm-login.D2fPD4ob_Z1FzXOr.webp", "featured"},
			{"https://tmox.net/_astro/tg-gm-m-login.BYzGoIZV_1zIl5l.webp", "thumb"},
			{"https://tmox.net/_astro/tg-gm-assessments.DkGfMoIL_1JmmFk.webp", "featured"},
			{"https://tmox.net/_astro/tg-gm-m-assessments.BffWc2WW_2cINXH.webp", "thumb"},
			{"https://tmox.net/_astro/tg-gm-tg.CxWQOYmD_eS8vf.webp", "featured"},
			{"https://tmox.net/_astro/tg-gm-m-tg.DU8-2nRC_eC6Nr.webp", "thumb"},
			{"https://tmox.net/_astro/tg-gm-matrix.DdBz-1SP_1UGfnC.webp", "featured"},
			{"https://tmox.net/_astro/tg-gm-m-matrix.Bgu6yTrD_Z2pF0HH.webp", "thumb"},
		},
		"ntr": {
		...
		// interleaved desktop (featured) + mobile (thumb) pairs
		"saj": {
			{"https://tmox.net/_astro/saj-desktop-1.yzr4oNf7_1lGKVw.webp", "featured"},
			{"https://tmox.net/_astro/saj-mobile-1.y0s5BNc8_Z2hUBDr.webp", "thumb"},
			{"https://tmox.net/_astro/saj-desktop-2.C5IC1az2_Z2taXU0.webp", "featured"},
			{"https://tmox.net/_astro/saj-mobile-2.CBQLf0yJ_1R3Dg5.webp", "thumb"},
			{"https://tmox.net/_astro/saj-desktop-3.BAzzm79G_Z12E9jp.webp", "featured"},
			{"https://tmox.net/_astro/saj-mobile-4.D8EQN3jH_17Gafh.webp", "thumb"},
			{"https://tmox.net/_astro/saj-desktop-4.DtFPS7rF_Z1gphrG.webp", "featured"},
			{"https://tmox.net/_astro/saj-mobile-5.B7dTHg5B_Z1jkCur.webp", "thumb"},
			{"https://tmox.net/_astro/saj-desktop-5.CC84lQ-S_Z21AUKP.webp", ""},
			{"https://tmox.net/_astro/saj-elements.DUNCTuAM_Z1AuXIT.webp", ""},
		},
		"fredst": {
			{"https://tmox.net/_astro/fredst-web-company-2.4FBv51c5_28Q6dR.webp", "featured"},
			{"https://tmox.net/_astro/fredst-web-mobile-2.DhNe71h9_2cBlVH.webp", "thumb"},
			{"https://tmox.net/_astro/fredst-web-climate.BRYL60I-_Z1WI0Sd.webp", "featured"},
			{"https://tmox.net/_astro/fredst-web-mobile-3.Bdr-8qwQ_Z2tnmeU.webp", "thumb"},
			{"https://tmox.net/_astro/fredst-web-projects-1.B8QEva8B_Z18GhDM.webp", "featured"},
		...
		"ynk": {
			{"https://tmox.net/_astro/ynk-web-dark-home.CPv2KHFJ_1MRK7C.webp", "featured"},
			{"https://tmox.net/_astro/ynk-web-dark-mobile.ByCqFPul_1zpOQr.webp", "thumb"},
			{"https://tmox.net/_astro/ynk-web-light-home.3G8NYa4R_Z1pyfsw.webp", "featured"},
			{"https://tmox.net/_astro/ynk-web-light-mobile.CWRBTUK3_Z2sG40n.webp", "thumb"},
